...
public class CMM1 {
	...
	public String getAssgdToLgnId() {
		return assgdToLgnId;
	}

	public void setAssgdToLgnId(String assgdToLgnId) {
	...
	public CMM1(Long cmmId, String cmmChseCd, Long memId, Long cpmgId, String cmpgCd, Integer msrVer,
	        ...
	        String cmmChseSts, String assgdToLgnId, Date validFromDate, Date validToDate, Boolean deleted,
